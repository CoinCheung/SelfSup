...
from cbl_models.resnet_base import ResNetPixPro


backbone = dict(use_blur_pool=False, ibn='b')
...
class PixPro(BaseModel):
    def __init__(self, base_encoder, args):
        ...
        self.encoder = ResNetPixPro(**backbone)
        self.projector = Proj_Head()

        # create the encoder_k
        self.encoder_k = ResNetPixPro(**backbone)
